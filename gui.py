...
# Assuming 'generate_suggestion' is defined in your 'perfect_getaways' module
from perfect_getaways import generate_suggestion
...
# Adjust the size of columns and rows to expand according to the content
